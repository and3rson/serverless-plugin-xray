...
describe('serverless-plugin-xray', function() {
    ...
    function runPlugin(params) {
        ...
        serverlessInstance.service.custom = params.custom;
    ...
    it('enables tracing when custom.serverless-plugin-xray.tracing=true', function() {
        const plugin = runPlugin({
            functions: {
                healthcheck: {
                },
    ...
    it('does not enable tracing when custom.serverless-plugin-xray.tracing=true but function.tracing=false', function() {
        const plugin = runPlugin({
            functions: {
                healthcheck: {
                    tracing: false
